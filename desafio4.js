...
searchButton.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
    var lista, queryHTMLElement, query, listaDeFilmes, ul, _i, _a, item, li;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                queryHTMLElement = document.getElementById('search');
                query = queryHTMLElement.value;
...
function preencherSenha() {
    var passwordHTMLElement = document.getElementById('senha');
    password = passwordHTMLElement.value;
    validateLoginButton();
}
function preencherLogin() {
    var usernameHTMLElement = document.getElementById('login');
    username = usernameHTMLElement.value;
    validateLoginButton();
}
function preencherApi() {
    var apiKeyHTMLElement = document.getElementById('api-key');
